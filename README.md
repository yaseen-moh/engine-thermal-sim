...
**[Try the live demo →](./demo/index.html)** (choose chamber material, adjust masses and safe-temperature limits, set ambient ­temperature and heat-rejection rate, and pick a heat profile — constant, pulsed, or ramp-up — to see how each affects overheat risk, no install needed.)

![Thermal profiles](thermal_profiles.png)
